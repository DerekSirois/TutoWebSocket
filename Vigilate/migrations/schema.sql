...
--
-- Name: trigger_set_timestamp(); Type: FUNCTION; Schema: public; Owner: dev
--
...
ALTER FUNCTION public.trigger_set_timestamp() OWNER TO dev;
...
--
-- Name: preferences; Type: TABLE; Schema: public; Owner: dev
--
...
ALTER TABLE public.preferences OWNER TO dev;

--
-- Name: preferences_id_seq; Type: SEQUENCE; Schema: public; Owner: dev
--
...
ALTER TABLE public.preferences_id_seq OWNER TO dev;

--
-- Name: preferences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dev
--
...
--
-- Name: remember_tokens; Type: TABLE; Schema: public; Owner: dev
--
...
ALTER TABLE public.remember_tokens OWNER TO dev;

--
-- Name: remember_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: dev
--
...
ALTER TABLE public.remember_tokens_id_seq OWNER TO dev;

--
-- Name: remember_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dev
--
...
--
-- Name: preferences id; Type: DEFAULT; Schema: public; Owner: dev
--
...
--
-- Name: remember_tokens id; Type: DEFAULT; Schema: public; Owner: dev
--
...
--
-- Name: preferences preferences_pkey; Type: CONSTRAINT; Schema: public; Owner: dev
--
...
--
-- Name: remember_tokens remember_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: dev
--
...
--
-- Name: sessions_expiry_idx; Type: INDEX; Schema: public; Owner: dev
--
...
--
-- Name: preferences set_timestamp; Type: TRIGGER; Schema: public; Owner: dev
--
...
--
-- Name: remember_tokens set_timestamp; Type: TRIGGER; Schema: public; Owner: dev
--
...
--
-- Name: users set_timestamp; Type: TRIGGER; Schema: public; Owner: dev
--
...
--
-- Name: remember_tokens remember_tokens_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: dev
--
